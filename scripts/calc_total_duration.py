...
name_list = [
    "2.2.1- 接口及实现类(上)-成片.mp4",
    "2.1.1-Servlet技术-成片.mp4",
    "1.1.1-成片-12.7.mp4",
    "1.1.2-成片-12.7.mp4",
    "2.5.1-转发与重定向-成片.mp4",
    "2.6.1-过滤器与监听器-成片.mp4",
    "3.1.1-JDBC基础(下)-成片.mp4",
    "2.3.1-servlet配置-成片.mp4",
    "2.7.1-Servlet并发处理-成片.mp4",
    "3.1.1-JDBC基础(上)-成片.mp4",
    "2.2.1- 接口及实现类(下)-成片.mp4",
    "2.8.1-JSP-成片.mp4",
    "2.4.1-cookie和session-成片.mp4",  #& ->和
    "3.3.1-SQL注入与防范-成片.mp4",
    "3.2.1-数据池链接-成片.mp4",
    "3.5.2-MyBatis进阶-成片.mp4",
    "4.1.1-Spring框架-概述-成片(下).mp4",
    "3.5.1-MyBatis入门-成片.mp4",
    "3.1.2-JDBC进阶-成片.mp4",
    "3.4.1-成片-1.7.mp4",
    "4.1.1-Spring框架-概述-成片(上).mp4",
    "3.4.2-死锁分析与解决-成片.mp4",
    "4.3.2-AOP使用-成片（上）.mp4",
    "4.1.1-Spring框架-概述-成片(中).mp4",
    "4.2.1- IoC容器-成片-.mp4",
    "4.2.2-依赖注入-成片（中）.mp4",
    "4.3.2-AOP使用-成片（下）.mp4",
    "4.2.2-依赖注入-成片（上）.mp4",
    "4.3.1-成片-12.14.mp4",
    "4.2.2-依赖注入-成片（下）.mp4",
    "4.2.1- IoC容器-成片-_0.mp4",
    "4.4.1-Spring JDBC-成片(中).mp4",
    "4.4.1-Spring JDBC-成片(上).mp4",
    "4.5.2-实现controller-成片(下).mp4",
    "4.5.1- Web框架概述-成片.mp4",
    "4.5.3-Web框架-View解析-成片(上).mp4",
    "4.4.3-整合Mybatis-成片.mp4",
    "4.4.2-数据访问-事务管理-成片（下）.mp4",
    "4.4.2-数据访问-事务管理-成片（中）.mp4",
    "4.5.2-实现controller-成片(上).mp4",
    "4.4.2-数据访问-事务管理-成片（上）.mp4",
    "4.4.1-Spring JDBC-成片(下).mp4",
    "4.5.4-工程模板-成片.mp4",
    "4.5.3-Web框架-View解析-成片(下).mp4",
    "4.5.5-Web框架-FreeMarker-成片.mp4",
]
...
def find(name):
    media_name = name.replace(".mp4","")
    media_name = name.replace(".mp3","")
...
for name in name_list:
    ...
    media_name = name.rstrip(".mp3")

    # id_name_map[media.get("media_id")] = media_name

    # print media_name,media.get("duration")
...
print  'length:%s'%len(name_list)
print  'seconds:%s'%total
print 'minutes:%s'%(total/60.0)
print 'hour:%s'%turn_date(total)


import os
os.system("say -v Ting-Ting  好")